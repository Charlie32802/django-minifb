...
EMAIL_HOST_USER = os.getenv('EMAIL_HOST_USER')  # Read from .env file
EMAIL_HOST_PASSWORD = os.getenv('EMAIL_HOST_PASSWORD')  # Read from .env file

DEFAULT_FROM_EMAIL = EMAIL_HOST_USER  # Same Gmail address for sending
